  ...
  return <View style={styles.surface} accessibilityViewIsModal={Platform.OS === 'web' ? undefined : true}>
    <View style={styles.header}>
      <View style={{ flex: 1 }}>
        ...
        <Text style={styles.subtitle}>{choice ? 'When should you two go?' : scoped && !elsewhere ? `What sounds good at ${scoped.name}?` : 'Pick an idea, then we’ll find the right time.'}</Text>
      </View>
