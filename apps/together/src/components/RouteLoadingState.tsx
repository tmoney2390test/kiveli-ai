...
export function RouteLoadingState({ pathname, label }: { pathname: string; label?: string }) {
  ...
  return <View accessibilityLabel={label ?? loadingLabel(kind)} accessibilityLiveRegion="polite" style={styles.root}>
    <View style={styles.frame}>
      ...
      {kind === 'home' || kind === 'explore' || kind === 'stories' ? <View style={[styles.hero, kind === 'stories' && styles.storyHero]}><View style={styles.heroCopy}><View style={styles.eyebrow}/><View style={styles.title}/><View style={styles.line}/><View style={styles.button}/></View></View> : null}
