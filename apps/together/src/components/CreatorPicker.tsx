...
const styles = StyleSheet.create({
  ...
  worldShade: { position: 'absolute', left: 0, right: 0, bottom: 0, height: 86, backgroundColor: Platform.OS === 'web' ? 'transparent' : 'rgba(0,0,0,.48)', ...(Platform.OS === 'web' ? ({ backgroundImage: 'linear-gradient(180deg, transparent, rgba(0,0,0,.75))' } as never) : {}) },
