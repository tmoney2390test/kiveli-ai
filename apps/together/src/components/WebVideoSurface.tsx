...
const loaderCoreStyle={width:12,height:12,borderRadius:999,background:'linear-gradient(135deg,#F06A9D,#A676FF)',boxShadow:'0 0 12px rgba(240,106,157,.72)'};
