...
import {caldersRunWorld,caldersRunLocations} from './worlds/calders-run';
...
import { vharadrenLocations, vharadrenWorld } from './worlds/vharadren';
...
export const demoSnapshot={
  ...
  profile:{display_name:'Tim',age_verified_at:'2026-01-01T00:00:00.000Z',private_text_preference:'explicit',private_text_preference_recorded_at:'2026-01-01T00:00:00.000Z',ai_data_consent_recorded_at:'2026-01-01T00:00:00.000Z',onboarding_completed_at:'2026-01-01T00:00:00.000Z',active_companion_instance_id:'20000000-0000-4000-8000-000000000001',interests:['Sports','Movies','Photography'],experience_goals:['Dating','Stories'],memory_categories:{semantic:true,preference:true,episodic:true,relationship:true,emotional:true,open_thread:true}},
  worlds:[{id:'10000000-0000-4000-8000-000000000001',slug:'juniper-city',name:'Juniper City',description:'A city full of people, places, and stories.',access_type:'free',timezone:'America/New_York',sort_order:0,featured:true,published:true,visual_context:{setting:'A contemporary creative city.'},metadata:{}},portVervelleWorld,neonKyoWorld,vespormoorWorld,northvaleWorld,eosMeridianWorld,vharadrenWorld,caldersRunWorld],
  locations:[
