...
import{consumePendingBirthdate,earliestAdultBirthdate,latestAdultBirthdate,rememberPendingBirthdate,validBirthdateEntry}from'./pendingBirthdate';
...
describe('pending account birthdate',()=>{
  ...
  it('matches the server maximum supported age',()=>{expect(earliestAdultBirthdate(new Date(2026,8,6,9))).toBe('1906-09-06');});
