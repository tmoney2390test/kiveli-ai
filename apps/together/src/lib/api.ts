...
export const animateMedia = (sourceMediaId:string,settings:VideoRequestSettings,motionPreset:VideoMotionPreset,prompt:string,requestId:string) => manageMedia<{media:GeneratedMedia;creditCost:number;creditBalance:number;route:VideoRouteOption}>({action:'animate',sourceMediaId,settings,motionPreset,prompt,requestId});
