...
export const neonKyoWorld:World={
  ...
  metadata:{
    ...
    populationArchetypes:['corporate professional','club worker','hacker','augmented artist','medical specialist','tower resident','civic engineer','privacy operator','synthetic-rights advocate','investigative editor'],
    residentCompanionCount:45,
    residentPortraitStatus:'ready',
    mappedResidentPortraitCount:45,
    maleResidentCompanionCount:15,
