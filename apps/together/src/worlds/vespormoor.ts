...
export const VESPORMOOR_CANONICAL_LORE={
  ...
  founding:'In 1712, the mysterious physician and aristocrat Lucien Vesper arrived with his sister Isolde, purchased much of the valley, and built Vesper House overlooking the lake. They created a sanctuary for the Veiled: vampires, witches, immortals, shapeshifters, and other beings who had survived by hiding among humanity.',
  covenant:'The Vesper Covenant binds the oldest families to secrecy, mutual protection, and strict limits on supernatural behavior. No resident may expose the Veiled to the outside world, prey upon an unwilling townsperson, or bring an ancient supernatural conflict into the valley.',
...
export const vespormoorWorld:World={
  ...
  slug:'vespormoor',
  name:'Vespormoor',
  description:'A mist-bound mountain town where humans and the Veiled have lived under an ancient covenant for three centuries—and something beneath Lake Vesper is beginning to wake.',
  ...
  published:true,
  visual_context:{
    setting:'secluded Gothic mountain town surrounding black Lake Vesper, hidden by dense forest, steep peaks, and persistent supernatural mist',
    ...
    architecture:['Victorian Gothic townhouses','rain-dark stone civic buildings','candlelit shopfronts','ancient university halls','secluded manor estates','Vesper House above the lake'],
    climate:'cool wet mountain climate with frequent fog, rain, and long winters',
    visualStyle:['grounded Gothic romantic realism','blue-gray mist against warm candlelight','wet cobblestone reflections','quiet supernatural tension'],
    ...
    avoid:['overt high-fantasy spectacle','visible monsters in ordinary public scenes','graphic horror or gore','modern glass skyline','cyberpunk neon','theme-park Gothic'],
  },
  metadata:{
    releaseWave:9,
    early_access:true,
    ...
    supernaturalResidents:['vampires','witches','immortals','shapeshifters','other Veiled beings'],
    covenantRules:['Keep the Veiled secret from the outside world.','Never prey upon an unwilling townsperson.','Do not bring ancient supernatural conflicts into the valley.'],
...
function location(input:VespormoorLocationSeed):Location{
  ...
  return{
    ...
    possible_activities:input.activities,visual_asset_key:null,sort_order:input.index*10,
    ...
    metadata:{tags:input.activities,district:districtNode?true:district,photoStatus:'world_fallback',source:'author_catalog_2026-08-20'},
  };
}
...
export const vespormoorLocations:Location[]=[
  ...
  location({index:8,parent:1,district:'Old Vesper',name:'The Black Lantern',slug:'the-black-lantern',description:'A candlelit pub inside a former coaching inn and one of Vespormoor’s oldest social institutions.',category:'pub',type:'venue',activities:['drinks','dinner','local stories','late conversation']}),
  ...
  location({index:11,parent:1,district:'Old Vesper',name:'The Mourning Cup',slug:'the-mourning-cup',description:'A cozy café famous for pastries, dark coffee, rain-covered windows, and lingering conversations.',category:'cafe',type:'venue',activities:['coffee','pastries','reading','lingering conversation']}),
  ...
  location({index:23,parent:3,district:'Lakeward',name:'The Drowned Bell',slug:'the-drowned-bell',description:'An old waterfront tavern popular with fishermen, students, locals, and supernatural regulars.',category:'tavern',type:'venue',activities:['drinks','seafood','local stories','live music']}),
  ...
  location({index:27,parent:3,district:'Lakeward',name:'The Sunken Chapel',slug:'the-sunken-chapel',description:'A ruined stone structure beneath the lake that becomes partially visible when water levels fall.',category:'ruin',type:'landmark',activities:['ruin viewing','local history','investigation','lake mystery']}),

  location({index:28,parent:4,district:'Vespormoor University',name:'The Grand Hall',slug:'the-grand-hall',description:'An enormous vaulted gathering hall used for ceremonies, dinners, dances, and major university events.',category:'hall',type:'venue',activities:['ceremonies','formal dinners','dances','university events']}),
  ...
  location({index:34,parent:4,district:'Vespormoor University',name:'The Observatory',slug:'the-observatory',description:'A remote domed observatory above the estate, popular for astronomy classes and late-night dates.',category:'observatory',type:'venue',activities:['stargazing','astronomy','late-night date','research']}),
  location({index:35,parent:4,district:'Vespormoor University',name:'The Undercroft',slug:'the-undercroft',description:'Ancient tunnels, crypts, forgotten rooms, and sealed passages beneath the castle.',category:'underground',type:'zone',activities:['exploration','archive search','crypt visit','investigation']}),
  ...
  location({index:37,parent:4,district:'Vespormoor University',name:'The High Gardens',slug:'the-high-gardens',description:'Vast terraced gardens with fountains, hedge mazes, glasshouses, secluded benches, and cliffside overlooks.',category:'garden',type:'outdoor',activities:['garden walk','hedge maze','cliff views','quiet date']}),
  ...
  location({index:40,parent:5,district:'Thornwood',name:'Foxglove Cabin Retreats',slug:'foxglove-cabin-retreats',description:'Beautiful secluded cabins scattered through the forest.',category:'cabins',type:'residence',activities:['cabin stay','fireside evening','forest walk','private retreat']}),
  location({index:41,parent:5,district:'Thornwood',name:'The Crooked Oak',slug:'the-crooked-oak',description:'A rustic tavern and restaurant frequented by locals, hikers, hunters, and shapeshifters.',category:'tavern',type:'venue',activities:['rustic dinner','drinks','trail stories','local gathering']}),
  ...
  location({index:43,parent:5,district:'Thornwood',name:'The Standing Stones',slug:'the-standing-stones',description:'An ancient stone circle still used for supernatural rituals.',category:'ritual site',type:'landmark',activities:['ritual observance','history','night visit','quiet reflection']}),
  ...
  location({index:46,parent:6,district:'Raven Ward',name:'The Crimson Room',slug:'the-crimson-room',description:'An exclusive members-only lounge popular with wealthy supernatural residents.',category:'lounge',type:'venue',activities:['cocktails','private conversation','networking','people watching']}),
  ...
  location({index:50,parent:6,district:'Raven Ward',name:'The Red Market',slug:'the-red-market',description:'A hidden nighttime marketplace for supernatural goods, rare ingredients, information, and illicit services.',category:'night market',type:'venue',activities:['night market','rare ingredients','information trading','supernatural goods']}),
