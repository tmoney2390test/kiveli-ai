...
export default ({ config }: ConfigContext): ExpoConfig => ({
  ...config,
  name: 'Together', slug: 'together', scheme: 'together', version: '1.0.0', orientation: 'portrait', userInterfaceStyle: 'dark',
  icon: './assets/icon.png',
  ios: { supportsTablet: true, bundleIdentifier: 'com.together.world', infoPlist: { NSPhotoLibraryUsageDescription: 'Choose a profile photo for your Together profile.' } },
