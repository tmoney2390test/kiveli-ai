...
export default function MediaViewer(){
  ...
  return <View style={styles.screen}>
    ...
    {media.media_type==='video'&&media.status==='ready'&&videoPlaybackUrl?<VideoLightbox visible={videoFullscreenOpen} uri={videoPlaybackUrl} posterUri={videoPosterUrl} aspectRatio={videoRatio} onClose={()=>setVideoFullscreenOpen(false)}/>:null}
