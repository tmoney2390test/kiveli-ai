...
export default function MediaViewer(){
  ...
  useEffect(()=>{if(Platform.OS==='web')return;if(videoFullscreenOpen)player.pause();else if(videoPlaybackUrl){player.muted=true;player.play();}},[player,videoFullscreenOpen,videoPlaybackUrl]);
