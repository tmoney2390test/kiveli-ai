...
export default function ConversationControls() {
  ...
  return <Screen>
    ...
    {selected ? <View style={styles.confirm}>
      ...
      {previewLoading ? <Text style={styles.previewText}>Loading what will be removedâ€¦</Text> : preview ? <View style={styles.previewBox}>
        <Text style={styles.previewTitle}>This Life will lose</Text>
        <Text style={styles.previewText}>{preview.counts.conversations} conversations Â· {preview.counts.memories} memories Â· {preview.counts.upcomingPlans} upcoming plans</Text>
        <Text style={styles.previewText}>{preview.counts.historicalPlans} past plans Â· {preview.counts.dates} Dates Â· {preview.counts.moments} Moments</Text>
        <Text style={styles.previewText}>{preview.counts.photos} photos Â· {preview.counts.stories} stories</Text>
      </View> : null}
