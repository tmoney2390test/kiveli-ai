...
export default function Memories() {
  ...
  const menu = (memory: Memory) => Alert.alert('Memory controls', memory.canonical_text, [{ text: memory.pinned ? 'Unpin' : 'Pin', onPress: () => void update('pin', memory) }, { text: 'Edit', onPress: () => edit(memory) }, { text: 'Forget', style: 'destructive', onPress: () => void update('forget', memory) }, { text: 'Cancel', style: 'cancel' }]);
