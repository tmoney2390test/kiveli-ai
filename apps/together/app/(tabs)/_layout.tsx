...
export default function TabsLayout() {
  ...
  return <Tabs screenOptions={{
    ...
    tabBarStyle: {
      ...
      ...(web ? { position: 'fixed' as never, zIndex: 100, width: webBarWidth, left: '50%', marginLeft: -webBarWidth / 2, bottom: width < 620 ? 10 : 18, borderRadius: 24, borderWidth: 1, borderColor: colors.border, overflow: 'hidden' } : {}),
    },
    ...
    <Tabs.Screen name="chat-tab" options={{ title: 'Chat', tabBarStyle: { display: 'none' }, tabBarIcon: ({ color, focused }) => <MessageCircle color={focused ? '#fff' : color} size={focused ? 29 : 25} fill={focused ? colors.rose : 'transparent'} /> }} />
