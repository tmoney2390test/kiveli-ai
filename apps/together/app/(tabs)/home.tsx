...
import { CalendarDays, ChevronRight, Coffee, Coins, Heart, Sparkles, UserRound } from 'lucide-react-native';
...
const styles = StyleSheet.create({
  ...
  topActions: { flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', gap: 8, flexShrink: 1 },
  ...
  creditChip: { minHeight: 42, flexDirection: 'row', alignItems: 'center', gap: 6, paddingLeft: 7, paddingRight: 9, borderRadius: radius.pill, backgroundColor: 'rgba(37,26,41,.94)', borderWidth: 1, borderColor: 'rgba(232,93,140,.27)', shadowColor: '#9B63D7', shadowOpacity: .14, shadowRadius: 10, shadowOffset: { width: 0, height: 5 } },
  creditChipPressed: { opacity: .82, transform: [{ scale: .97 }] },
  creditDot: { width: 28, height: 28, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(233,160,127,.10)' },
  creditValue: { color: colors.text, fontSize: 11, fontWeight: '900' },
  creditAdd: { color: '#F4BDD0', fontSize: 9, fontWeight: '900' },
  tierPill: { paddingHorizontal: 6, paddingVertical: 4, borderRadius: radius.pill, backgroundColor: 'rgba(232,93,140,.16)' },
  tierPillMax: { backgroundColor: 'rgba(154,99,215,.19)' },
  tierPillText: { color: '#EACBDB', fontSize: 7, fontWeight: '900', letterSpacing: .6 },
