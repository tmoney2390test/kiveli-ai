...
import { markProactiveOpened, simulate } from '../../src/lib/api';
...
export default function Home() {
  ...
  return <Screen contentStyle={styles.content}>
    ...
    <CharacterHero character={maya} location={location} onPress={() => router.push('/character/maya')} />
    ...
    <SectionHeader title="Tonight" action="City Life" onAction={() => router.push('/(tabs)/worlds')} />
