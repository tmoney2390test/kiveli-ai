...
import { defaultDirectConversationTitle } from '../../src/lib/conversation';
...
export default function ConversationHistory() {
  ...
  return <Screen>
    <View style={styles.header}><Pressable accessibilityLabel="Back" onPress={() => router.canGoBack() ? router.back() : router.replace('/conversation-controls')}><ArrowLeft color={colors.text} /></Pressable><CharacterAvatar slug={character.together_character_templates.slug} /><View style={{ flex: 1 }}><PageTitle>Conversation history</PageTitle><Text style={styles.subtitle}>Your conversations with {name}</Text></View></View>
