...
const styles = StyleSheet.create({
  ...
  hero: { position: 'relative', overflow: 'hidden', gap: 24, padding: 22, borderRadius: radius.xl, backgroundColor: '#1A1124', borderWidth: 1, borderColor: 'rgba(232,93,140,.38)', shadowColor: '#A85CFF', shadowOpacity: .22, shadowRadius: 28, shadowOffset: { width: 0, height: 14 } },
  glowOne: { position: 'absolute', width: 230, height: 230, borderRadius: 115, right: -86, top: -96, backgroundColor: 'rgba(154,99,215,.28)' },
  glowTwo: { position: 'absolute', width: 210, height: 210, borderRadius: 105, left: -105, bottom: -130, backgroundColor: 'rgba(232,93,140,.20)' },
  ...
  currentPill: { flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 9, paddingVertical: 6, borderRadius: radius.pill, backgroundColor: 'rgba(232,93,140,.78)' },
  ...
  billingChoiceActive: { backgroundColor: colors.elevated, borderWidth: 1, borderColor: 'rgba(232,93,140,.35)' },
  ...
  planFeatured: { paddingTop: 24, backgroundColor: '#211226', borderColor: 'rgba(232,93,140,.48)', shadowColor: '#E85D8C', shadowOpacity: .16, shadowRadius: 18, shadowOffset: { width: 0, height: 8 } },
