...
const styles = StyleSheet.create({
  ...
  memberHero: { position: 'relative', minHeight: 286, overflow: 'hidden', justifyContent: 'center', padding: 30, borderRadius: radius.xl, backgroundColor: '#180B1A', borderWidth: 1, borderColor: 'rgba(244,124,181,.5)' }, memberHeroCompact: { minHeight: 330, padding: 20 }, memberHeroScrim: { ...StyleSheet.absoluteFill, backgroundColor: 'rgba(6,3,9,.13)', ...(Platform.OS === 'web' ? ({ backgroundImage: 'linear-gradient(90deg, rgba(6,3,9,.99) 0%, rgba(11,5,14,.91) 46%, rgba(11,5,14,.18) 72%, rgba(7,3,10,.04) 100%)' } as never) : {}) }, memberHeroScrimCompact: { backgroundColor: 'rgba(7,3,10,.58)', ...(Platform.OS === 'web' ? ({ backgroundImage: 'linear-gradient(90deg, rgba(7,3,10,.95), rgba(7,3,10,.48))' } as never) : {}) }, memberPlanColumn: { zIndex: 2, width: '100%', maxWidth: 570, gap: 8 }, memberPlanName: { color: '#FFF5EA', fontFamily: 'Georgia', fontSize: 39, lineHeight: 46 }, memberPrice: { color: '#FFF5EA', fontFamily: 'Georgia', fontSize: 30 }, memberPeriod: { color: colors.muted, fontSize: 12 }, memberBilling: { color: colors.muted, fontSize: 11, lineHeight: 17 }, renewalLine: { color: '#DCCBD8', fontSize: 11 }, memberActions: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginTop: 10 }, memberActionButton: { minWidth: 170 },
