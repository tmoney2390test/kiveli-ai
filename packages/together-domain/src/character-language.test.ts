...
describe('character language', () => {
  it.each([
    ...
    ['Picking up a few practical things without rushing what comes next', 'Running a few errands'],
    ['Checking the market without rushing what comes next', 'Checking the market'],
