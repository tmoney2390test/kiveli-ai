...
export const VIDEO_CATALOG_VERSION = '2026-09-10-two-tiers-v3';
export const VIDEO_CREDIT_DEFAULTS = { creditsPerUnit: 250, minimumCredits: 25 };
export const VIDEO_CONSUMER_TIERS = [
  { id: 'tier:standard', tier: 'standard', name: 'Standard', description: 'Everyday moments with optional sound', resolution: '720p', resolutions: ['480p', '720p', '1080p'], durations: [5, 10], audioMode: 'toggleable', creditsPerSecond: [3, 6.5, 13] },
  { id: 'tier:premium', tier: 'premium', name: 'Premium', description: 'Longer scenes with stereo sound', resolution: '768p', resolutions: ['480p', '768p', '1080p'], durations: Array.from({ length: 13 }, (_, i) => i + 3), audioMode: 'always', creditsPerSecond: [10, 20, 40] },
] as const;
