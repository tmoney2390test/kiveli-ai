...
export const VIDEO_CATALOG_VERSION = '2026-09-10-two-tiers-v2';
...
export const VIDEO_CONSUMER_TIERS = [
  ...
  { id: 'tier:premium', tier: 'premium', name: 'Premium', description: 'Longer scenes with stereo sound', resolution: '768p', resolutions: ['480p', '768p'], durations: Array.from({ length: 13 }, (_, i) => i + 3), audioMode: 'always', creditsPerSecond: [10, 20] },
] as const;
