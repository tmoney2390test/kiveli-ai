...
export type KivelleCapabilities={
  ...
  reasoningEffortMax:'low'|'medium'|'high';
...
const plusEntitlements:readonly EntitlementKey[]=[...freeEntitlements,
  'photo_sharing',
  'memory_deep','memory_inspector','memory_manual_control','history_expanded','all_standard_worlds','proactive_messages','multiple_lives','multiple_custom_companions','priority_media','director_selective',
  'group_chat',
...
export const subscriptionCatalog:Record<SubscriptionTier,KivelleCapabilities>={
  free:{tier:'free',displayName:'Kivelle Free',monthlyPriceUsd:0,annualPriceUsd:null,maxActiveConversations:5,dailyMessageLimit:20,userRequestedPhotoDailyLimit:12,includedCompanionPhotoDailyLimit:0,includedDatePhotoMonthlyLimit:0,intelligenceProfile:'core',reasoningEffortMax:'low',memoryRetrievalBudget:6,recentTurnBudget:10,historyRetrievalBudget:1,directorPolicy:'major_only',maxLives:1,maxCustomCompanions:1,worldAccess:'free',earlyWorldAccess:false,monthlyCreditGrant:0,subscriptionCreditRolloverCap:0,welcomeCredits:50,mediaQueue:'standard',entitlements:freeEntitlements},
  kivelle_plus:{tier:'kivelle_plus',displayName:'Kivelle+',monthlyPriceUsd:19.99,annualPriceUsd:199.99,maxActiveConversations:20,dailyMessageLimit:null,userRequestedPhotoDailyLimit:12,includedCompanionPhotoDailyLimit:1,includedDatePhotoMonthlyLimit:1,intelligenceProfile:'deep',reasoningEffortMax:'medium',memoryRetrievalBudget:12,recentTurnBudget:18,historyRetrievalBudget:3,directorPolicy:'meaningful',maxLives:3,maxCustomCompanions:5,worldAccess:'all_standard',earlyWorldAccess:false,monthlyCreditGrant:500,subscriptionCreditRolloverCap:1000,welcomeCredits:50,mediaQueue:'priority',entitlements:plusEntitlements},
...
export const creditCosts:Record<CreditAction,number>={companion_photo:10,photo_edit:10,photo_variant:10,premium_photo:20,creator_appearance_set:20,short_video:125,voice_note:2,voice_minute:20,voice_standard_minute:5};
...
export function capabilitiesForAccount(tier:string,metadata?:unknown):KivelleCapabilities{
  ...
  return{...base,dailyMessageLimit:entitlements.includes('chat_unlimited')?null:base.dailyMessageLimit,userRequestedPhotoDailyLimit:entitlements.includes('media_generation_unlimited')?null:base.userRequestedPhotoDailyLimit,entitlements};
}
