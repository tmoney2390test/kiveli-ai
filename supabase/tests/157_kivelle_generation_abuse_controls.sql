...
select ok(not has_function_privilege('authenticated','public.kivelle_claim_generation_request_anchor(uuid,uuid,text,text,integer)','Clients cannot claim request anchors directly');
