...
select policies_are('public','together_conversation_attachments',array['together_conversation_attachments_own_read'],'attachments are server-mutated and privately readable');
