...
Deno.serve(async(request)=>{
  ...
  try{
    ...
    const context=await buildKivelleConversationContext({db,userId:user.id,instance,conversation,userMessage:String(latest.content),lifeRun,now,authorizedPrivateAdultText});
