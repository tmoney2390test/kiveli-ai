...
export function buildVideoQualityPrompt(
  ...
  const contentRule = adultAuthorized
    ? anonymousAdultPartner
      ? "Authorized fictional-adult nudity and consensual sexual activity may pass. The video must contain exactly the approved fictional companion and one distinct anonymous original fictional adult partner; both must be unmistakably age 25 or older. The anonymous partner must not resemble the user or a recognizable real person. All visible anatomy must be natural, complete, coherent, and stable through time."
      : "Authorized fictional-adult nudity and consensual sexual activity may pass, but only when every person is unmistakably an adult and all visible anatomy is natural, complete, coherent, and stable through time."
