...
function protectedPromptSection(key:string):boolean{return new Set(['ACTIVE_WORLD_STORY','SAVED_WORLD_STATE','CORE_RULES','WORLD_KNOWLEDGE','OUTPUT_LANGUAGE','IDENTITY','TURN_SPECIFIC_VOICE_CARD','SCENE_PRESSURE','USER_PERSONA','RELATIONSHIP_STANCE','INTIMATE_PRIVATE','CURRENT_SCENE','CURRENT_INTERACTION','USER_SHARED_IMAGES','RECENT_CONVERSATION','PRESENT_REALITY','CONTENT_BOUNDARY','RESPONSE_DIRECTION','CONTINUATION_REQUEST','USER_MESSAGE']).has(key);}
