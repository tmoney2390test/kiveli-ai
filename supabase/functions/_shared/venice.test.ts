...
Deno.test('Venice standard media uses the documented multi-edit FireRed contract after a retryable primary model failure',async()=>{
  ...
  try{
    ...
    assert(submission.result?.estimatedCost===.09345);
