...
export type ContextReservation = { quoteId:string; requestId:string; userId:string; conversationId:string; preference:ContextPreference; ceiling:number; maximumReplies:number; replies:ContextReplyQuote[]; usedReplies:Set<string>; automatic?:boolean; };
