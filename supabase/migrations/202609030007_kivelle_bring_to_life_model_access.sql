...
-- Reserve an exact bring-to-life route while keeping the source photo's
-- policy authoritative. A restricted source must use a Spicy route. An
-- authorized website-adult session may also deliberately test a Spicy route
-- with an app-safe source; that result remains web-private and is still
-- required to pass the ordinary SFW output check.
create or replace function public.kivelle_reserve_video_generation_v5(
...
revoke all on function public.kivelle_reserve_video_generation_v5(uuid,uuid,uuid,text,text,text,text,text,text,text,integer,numeric,numeric,integer,text,text,boolean,text,text,boolean,integer,boolean,uuid) from public,anon,authenticated;
grant execute on function public.kivelle_reserve_video_generation_v5(uuid,uuid,uuid,text,text,text,text,text,text,text,integer,numeric,numeric,integer,text,text,boolean,text,text,boolean,integer,boolean,uuid) to service_role;
